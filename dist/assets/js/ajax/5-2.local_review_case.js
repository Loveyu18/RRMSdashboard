$.ajax({
    ...
    success: function (response) {
      const operators= []
      operators.push(...response.localUntrial)
  ...
  function createDomElement(operators) {
    ...
    .map((item) => {
        var a=item.recycleOverdue;  
        var b=item.recycleOverdue7;  
        var c=item.recycleOverdue14;  
        var d=item.recycleOverdue30;  
        var e=item.dealWithOverdue;  
        var f=item.dealWithOverdue7;  
        var g=item.dealWithOverdue14;  
        var h=item.dealWithOverdue30;  
        ...
        <div class="card-body pt-6">
            ...
            <div class="tab-content mt-9" id="myTabMixed2">
                <!--begin::Tab Pane-->
                <div class="tab-pane fade active show" id="kt_tab_mixed_2_1" role="tabpanel"
                ...
                <div class="tab-pane fade" id="kt_tab_mixed_2_2" role="tabpanel"
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-6">
                        ...
                        <!--begin::pulse-ring-->
                        <span class="label pulse pulse-success mr-10">
                            <span class="position-relative">${item.dealWithOverdue14}</span>
                            <span class="pulse-ring"></span>
                        </span>
                        <!--end::pulse-ring-->
                    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-6">
                        ...
                        <!--begin::pulse-ring-->
                        <span class="label pulse pulse-primary mr-10">
                            <span class="position-relative">${item.dealWithOverdue30}</span>
                            <span class="pulse-ring"></span>
                        </span>
                        <!--end::pulse-ring-->
                    <!--end::Item-->
    ...
    const list_of_operators = document.querySelector('.localUntrial')
